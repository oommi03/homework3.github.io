...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                this.$http.post('https://paiduay-a7d24.firebaseio.com/users/' + this.user.uid + '/books.json', this.book)
                .then(response => {         
            ...
            fetchData() {
                this.$http.get('https://paiduay-a7d24.firebaseio.com/users/' + this.user.uid + '/books.json')
                .then(response => {
            ...
            deleteData(key){
                this.$http.delete('https://paiduay-a7d24.firebaseio.com/users/' + this.user.uid + '/books/' + key + '.json')
                .then(response => {
                    this.fetchData();
                    console.log(response);           
                },error => {               
